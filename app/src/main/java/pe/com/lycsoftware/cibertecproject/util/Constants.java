...
public class Constants {
    ...
    public static final int REQUEST_CODE_USER = 10;
    public static final int REQUEST_CODE_USER_EDIT = 11;
    public static final int REQUEST_CODE_TASK_EDIT = 12;
    public static final int REQUEST_CODE_TASK_CREATE = 13;
    public static final int REQUEST_CODE_NOTIFICATION_CREATE = 14;
    public static final int REQUEST_CODE_NOTIFICATION_EDIT = 15;
